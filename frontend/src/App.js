      ...
      <div className="h-screen flex flex-col items-center justify-between p-6 relative overflow-hidden" 
        ...
        <div className="flex flex-col items-center">
          ...
          <div className={`space-y-3 w-64 md:w-72 relative z-20 transition-all duration-1000 delay-500 ${menuAnimated ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            {/* AQUARIUM BUTTON */}
            <button 
              onClick={() => { retroSounds.select(); setShowAquarium(true); }}
              className="w-full h-14 rounded-2xl font-bold text-white text-sm flex items-center justify-center gap-2 bg-gradient-to-r from-cyan-500 via-teal-500 to-blue-500 hover:from-cyan-400 hover:via-teal-400 hover:to-blue-400 border-2 border-cyan-400/50 shadow-lg shadow-cyan-500/30 transition-all"
              data-testid="aquarium-button"
            >
              <span className="text-xl">🐠</span>
              <span>AQUARIUM</span>
            </button>
